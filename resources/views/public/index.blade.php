...
@section('content')
    ...
    <div class="container pad">
        <h2>Контакты</h2>
        <div>
            Квест-проект «Темная комната»<br/>
            Адрес: г. Белгород, ул. 5 Августа, 31 (цокольный этаж, вход со двора в офис №4)<br/>
            Адрес: г. Белгород, ул. Губника, 17и (цокольный этаж, правая сторона здания) - скоро открытие<br/>
            Бронирование по телефону: 8 (904) 080-57-47<br/>
            <a href="https://vk.com/darkroomquest" target="_blank">https://vk.com/darkroomquest</a>
        </div>
    </div>
